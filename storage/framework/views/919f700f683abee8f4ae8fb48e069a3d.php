...
<body>
  ...
  <main id="main">
   ...
   <section id="login" class="login">
	...
	<link rel="stylesheet" type="text/css" href="<?php echo asset('register/css/my-login.css'); ?>">
<!-- </head> -->
	...
	<section class="h-100">
		<div class="container h-100">
			<div class="row justify-content-md-center h-100">
				<div class="card-wrapper">
					<div class="brand">
						<img src="<?php echo asset('/image/logofiks.PNG'); ?>" alt="">
					</div>
					<div class="card fat">
						<div class="card-body">
...
<?php /**PATH C:\Users\Fera\Downloads\E-KHASMAYU-WEB\resources\views/index.blade.php ENDPATH**/ ?>