          ...
          <p>Check Produk</p>
                            ...
                            <div class="row gy-4 justify-content-center">
                              ...
                              <div class="col-l-3 col-lg-3 col-md-4">
                                ...
                                <div class="card-body text-left">
                                  <h4 class="card-title">
                                    <a href="product.html" class=" font-weight-bold text-dark text-uppercase small"> Keripik Tempe</a>
                                    <h5 class="small text-left" style="color: grey">
                              ...
                              <div class="col-l-3 col-lg-3 col-md-4">
                                ...
                                <div class="card-body text-left">
                                  <h4 class="card-title">
                                    <a href="product.html" class=" font-weight-bold text-dark text-uppercase small"> Keripik Tike</a>
                                    <h5 class="small text-left" style="color: grey">
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <img src="assets/img/iklan-1.jpg" class="col-lg-8">
              </div>
            </div><!-- iklan -->

            <div class="swiper-slide">
              <div class="testimonial-item">
                    <img src="assets/img/iklan-2.jpg" class="col-lg-8">
                  </div>
            </div><!-- End testimonial item -->

            <div class="swiper-slide">
              <div class="testimonial-item">
                <img src="assets/img/iklan-3.jpg" class="col-lg-8">
              </div>
            </div><!-- End testimonial item -->
      ...
      <div class="container">
        ...
        <div class="row content">
          ...
          <div class="col-md-8 pt-4" data-aos="fade-up">
            ...
            <p class>
              Batik Dermayon atau Batik Paoman  adalah batik yang berasal dari indramayu yang memeiliki motif yang khas pesisir dan dipengaruhi oleh budaya motif Tiongkok.
            </p>
            <ul>
        ...
        <div class="row content">
          ...
          <div class="col-md-8 pt-5 order-2 order-md-1" data-aos="fade-up">
            ...
            <p>
            Keripik Tike sendiri berasal dari Desa Jumbleng Kecamatan Losarang Kabupaten Indramayu, olahan makanan ringan ini tetap eksis walau proses pembutanya masih tradisional oleh masyarakat setempat.
            </p>
            <p>
              Kripik Tike memiliki waran tekstur putih dan ada bintik hitam-kehitaman dan mempunyai rasa gurih dan asin.
          </div>
        </div>
        ...
        <div class="row content">
          ...
          <div class="col-md-8 pt-5" data-aos="fade-up">
            ...
            <p>Buah mangga dapat diolah menjadi berbagai bentuk minuman dan makanan salah satunya yaitu manisan mangga. Manisan buah adalah buah yang diawetkan dengan gula kadar tinggi untuk memberikan atau menambahkan rasa manis dan mencegah tumbuhnya mikroorganisme.</p>
            <ul>
              <li><i class="bi bi-check"></i> Dengan  rasa yang enak.</li>
              <li><i class="bi bi-check"></i> mangga dapat mengurangi risiko menderita diabetes, kanker, dan juga peradangan dalam tubuh.</li>
              <li><i class="bi bi-check"></i>  kaya antioksidan, terutama dalam bentuk polifenol dan karoten.</li>
            </ul>
            <p>
        ...
        <div class="row content">
          ...
          <div class="col-md-8 pt-5 order-2 order-md-1" data-aos="fade-up">
            ...
            <p>
              Mangga cengkir dikenal juga sebagi mangga Indramayu karena berasal dari daerah tersebut. Mangga cengkir disukai karena memiliki tekstur yang agak keras
            </p>
            <ul>
              <li><i class="bi bi-check"></i>  Mengurangi Kadar Kolesterol. Vitamin C yang tinggi dan kaya serat terdapat di dalam buah mangga dapat membantu menurunkan kadar kolesterol pada tubuh Anda.</li>
